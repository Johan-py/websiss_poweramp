...
import { RegistroEvaluacionDialog } from "@/features/RegistroEvaluacionDialog";
...
export function EvaluacionesPage() {
  ...
  }, [rol, perfil?.estudiante?.id, perfil?.docente?.id, reloadKey]);
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {rol !== "ESTUDIANTE" && (
          <Button size="sm" onClick={() => setOpen(true)}><Plus className="h-4 w-4 mr-1.5" /> Nueva Evaluación</Button>
        )}
      </PageHeader>
